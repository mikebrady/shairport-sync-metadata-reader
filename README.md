...
This sample program reads the pipe of metadata optionally generated by the development branch -- branch 2.3 -- of Shairport Sync. Shairport Sync is an AirTunes emulator with audio synchronization and multi-room capability -- https://github.com/mikebrady/shairport-sync. To use shairport-sync-metadata-reader, read the pipe via standard input, e.g.
