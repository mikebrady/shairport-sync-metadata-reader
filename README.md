...
* For `core` metadata, the second 4-character code is the 4-character metadata code that comes from iTunes etc. See this https://code.google.com/p/ytrack/wiki/DMAP for information.
